...
```{r, selected_counties, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
    ...
    print(covidPlot(cases~date | county, data=selected, subtitle=subtext, group=county, main="Selected Counties"))
    print(covidPlot(case.slope~date | county, data=selected, group=county, subtitle = subtext, main="Selected Counties", ylab="Slope (Cases/Day)"))
    print(covidPlot(100000*cases/county.population~date | county, data=selected, subtitle=subtext, group=county, main="Selected Counties",
          ylab="Cases per 100,000"))

    print(covidPlot(deaths~date | county, data=selected, subtitle=subtext, group=county, main="Selected Counties"))
    print(covidPlot(death.slope~date | county, data=selected, group=county, subtitle = subtext, main="Selected Counties", ylab="Slope (Deaths/Day)"))
    print(covidPlot(100000*deaths/county.population~date | county, data=selected, group=county, 
