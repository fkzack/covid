...
```{r, selected_counties_cases, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
    ...
    print(symmetricPlot(100000*case.slope/county.population~date | county, data=selected, group=selected$state, subtitle = subtext, main="Selected Counties", 
...
```{r, selected_counties_deaths, echo=FALSE, results='hide', message=FALSE,warning=FALSE}    
    ...
    print(symmetricPlot(100000*death.slope/county.population~date | county, data=selected, group=selected$state, subtitle = subtext, 
