...
```{r, get_data, include=FALSE}
    ...
    mi <- getCounties(getStateUrl('Michigan'),  countyPopulations)
...
```{r, selected_counties_cases, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
    ...
    print(covidPlot(case.slope~date | county, data=selected, group=state, subtitle = subtext, main="Selected Counties", 
...
```{r, selected_counties_deaths, echo=FALSE, results='hide', message=FALSE,warning=FALSE}    
    ...
    print(covidPlot(death.slope~date | county, data=selected, group=state, subtitle = subtext, 
                    main="Selected Counties", ylab="Slope (Deaths/Day)"))
