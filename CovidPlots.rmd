...
```{r, get_county_data, include=FALSE}
    ...
    hi <- getCountiesByChunk ('Hawaii', ISOdate(2020,3,1, tz=""), 5,  countyPopulations)
    tx <- getCountiesByChunk ('Texas', ISOdate(2020,3,1, tz=""), 5,  countyPopulations)
    fl <- getCountiesByChunk ('Florida', ISOdate(2020,3,1, tz=""), 5,  countyPopulations)
    ga <- getCountiesByChunk ('Georgia', ISOdate(2020,3,1, tz=""), 5,  countyPopulations)
...
```{r, selected_counties_cases, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
    ...
    plotCounty(selected,"Selected Counties", subtext)
...
```{r, selected_counties_deaths, echo=FALSE, results='hide', message=FALSE,warning=FALSE}    
  ...
  print(covidPlot(100000*deaths/county.population~date | county, data=selected, group=state, 
    ...
    print(covidPlot(deaths~date, data=selected, group=county, 
                    subtitle=subtext, main="Selected Counties",
                    auto.key= list(cex=0.6, columns=3),
                    par.settings= list(superpose.symbol=list(pch=1:25)) ))
    
    print(covidPlot(100000*deaths/county.population~date , data=selected, group=county, 
                    subtitle=subtext, 
                    main="Selected Counties",
                    ylab="Deaths per 100,000",
                    xlab="Date",
...
```{r, california_counties, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
   plotCounty(ca, "California Counties", subtext) 
```

## Covid in All New York Counties {.tabset}
Covid case counts and death counts by county, based on daily data from NY Times via https://covid-19.datasettes.com
```{r, new_york_counties, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
    plotCounty(ny, "New York Counties", subtext) 
```

## Covid in All Michigan Counties {.tabset}
Covid case counts and death counts by county, based on daily data from NY Times via https://covid-19.datasettes.com
```{r, michigan_counties, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
    plotCounty(mi, "Michigan Counties", subtext) 
```

## Covid in All Hawaii Counties {.tabset}
Covid case counts and death counts by county, based on daily data from NY Times via https://covid-19.datasettes.com
```{r, hawaii_counties, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
    plotCounty(hi, "Hawaii Counties", subtext) 
```

## Covid in All Texas Counties {.tabset}
Covid case counts and death counts by county, based on daily data from NY Times via https://covid-19.datasettes.com
```{r, texas_counties, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
    plotCounty(tx, "Texas Counties", subtext) 
```

## Covid in All Florida Counties {.tabset}
Covid case counts and death counts by county, based on daily data from NY Times via https://covid-19.datasettes.com
```{r, florida_counties, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
    plotCounty(fl, "Florida Counties", subtext) 
```

## Covid in All Georgia Counties {.tabset}
Covid case counts and death counts by county, based on daily data from NY Times via https://covid-19.datasettes.com
```{r, georgia_counties, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
    plotCounty(ga, "Georgia Counties", subtext) 
```
